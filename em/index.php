                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <form class="col s12 mt-4" name="signin" method="post">
                                ...
                                <div class="col s12 d-flex justify-content-between align-items-top mb-4">
                                    ...
                                    <div>
                                        <a href="forgot-password.php" class="small text-right">Lost password?</a>
                                    </div>
                                    <div>
                                        <a href="../admin/" class="small text-right">Admin?</a>
                                    </div>
                                </div>
